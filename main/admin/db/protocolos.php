    ...
    case 'listar':
        $sql = "SELECT p.*, 
                ...
                (SELECT COUNT(*) FROM fase_reactivos fr 
                 ...
                 INNER JOIN reactivos r ON fr.reactivo_id = r.id
                 WHERE fp2.protocolo_id = p.id AND r.estado = 'activo') as total_reactivos
