document.addEventListener("DOMContentLoaded", () => {
  ...
  <text x="20" y="26" text-anchor="middle" font-size="16" fill="#fff" font-family="Arial">INV</text>
    ...
    // Links adicionales SOLO para index.html
    const extraNavLinks = page === "index.html" ? `
        <li class="nav-item">
            <a href="/invitrosoft/main/crear_usuario.html" class="nav-link">
            ...
            <ul class="nav-menu">
                ...
                <div class="user-menu-container">
                    ...
                    <div class="dropdown-menu" id="desktop-dropdown-menu">
                        <a href="/invitrosoft/main/users/index.html" class="dropdown-item">
    ...
    <nav class="mobile-menu" id="mobile-menu">
        <div class="user-menu-container mobile-user-menu">
            <button type="button" class="user-menu-btn" id="mobile-user-btn">
                <img src="../img/adaniesbasilio.jpg" alt="Usuario" class="user-icon">
                <div class="user-info">
                    <span class="user-role">Administrador</span>
                    <span class="user-name">Adanies Basilio</span>
                </div>
        ...
        <div class="mobile-menu-content">
            <a href="index.html" class="mobile-menu-item ${page === 'index.html' ? 'active' : ''}">Panel Principal</a>
            <a href="reactivos.html" class="mobile-menu-item ${page === 'reactivos.html' ? 'active' : ''}">Reactivos</a>
            <a href="formulaciones.html" class="mobile-menu-item ${page === 'formulaciones.html' ? 'active' : ''}">Formulaciones</a>
            <a href="protocolo.html" class="mobile-menu-item ${page === 'protocolo.html' ? 'active' : ''}">Protocolos</a>
            <a href="categoria.html" class="mobile-menu-item ${page === 'categoria.html' ? 'active' : ''}">Categorías</a>
            <a href="parametros.html" class="mobile-menu-item ${page === 'parametros.html' ? 'active' : ''}">Parámetros</a>
            <a href="historial.html" class="mobile-menu-item ${page === 'historial.html' ? 'active' : ''}">Historial</a>
        </div>
